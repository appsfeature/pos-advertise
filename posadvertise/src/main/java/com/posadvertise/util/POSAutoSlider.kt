...
class POSAutoSlider(private var viewPager: ViewPager2?, private var indicatorView: WormDotsIndicator?, private var mProperty : ExtraProperty, private val mTransitionTime : Long) : DefaultLifecycleObserver{
    ...
    fun initUi(lifecycle: Lifecycle?, callback: POSAdvertiseCallback.OnClickListener) {
        ...
        viewPager?.let {
            it.adapter = AutoSliderAdapter(
                designType,
                mList, mProperty, object : POSAdvertiseCallback.OnClickListener{
